...
class TRExternalToolBar(QtGui.QToolBar):
	def __init__(self, *args, **kwargs):
		...
		self.btn_node_add.triggered.connect(lambda: TRNodeActionCollector.node_insert_dlg(eGlyph(), pLayers, get_modifier()))
		...
		self.btn_node_remove.triggered.connect(lambda: TRNodeActionCollector.node_remove(eGlyph(), pLayers))
		...
		self.btn_corner_mitre.triggered.connect(lambda: TRNodeActionCollector.corner_mitre_dlg(eGlyph(), pLayers))
		...
		self.btn_corner_round.triggered.connect(lambda: TRNodeActionCollector.corner_round_dlg(eGlyph(), pLayers))
		...
		self.btn_corner_loop.triggered.connect(lambda: TRNodeActionCollector.corner_loop_dlg(eGlyph(), pLayers))
		...
		self.btn_corner_trap.triggered.connect(lambda: TRNodeActionCollector.corner_trap_dlg(eGlyph(), pLayers, get_modifier()))
		...
		self.btn_corner_rebuild.triggered.connect(lambda: TRNodeActionCollector.corner_rebuild(eGlyph(), pLayers))
